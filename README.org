...
** Commit cycle
Manually assemble your next save point in the Staging Area. When you're happy with it, commit it to the repository to create a new version of your project.
...
1. You can identify commit by unique ID or by HEAD offset (H, HEAD~1, HEAD~2,...)
...
** Show changes to Workspace and Staging
1. Edit the file
   #+BEGIN_EXAMPLE
   1. Cherry tomatoes
   2. Italian basil
